...
public class Listeners_Laxmi implements ITestListener, ISuiteListener,
		IInvokedMethodListener {

	public void onFinish(ISuite arg0) {
		// TODO Auto-generated method stub
		Reporter.log("About to end executing Suite " + arg0.getName() + "<br>",
				true);
	}

	public void onStart(ISuite arg0) {
		// TODO Auto-generated method stub
		Reporter.log("About to begin executing Suite " + arg0.getName()
				+ "<br>", true);
	}
	...
	public void onStart(ITestContext arg0) {
		Reporter.log(
				"About to begin executing Test " + arg0.getName() + "<br>",
				true);
	}
	...
	public void onFinish(ITestContext arg0) {
		Reporter.log("Completed executing test " + arg0.getName() + "<br>",
				true);
	}
	...
	// This belongs to IInvokedMethodListener and will execute before
	// every method including @Before @After @Test
	public void beforeInvocation(IInvokedMethod arg0, ITestResult arg1) {
		String textMsg = "About to begin executing following method : "
				+ returnMethodName(arg0.getTestMethod());
		Reporter.log(textMsg + "<br>", true);
	}
